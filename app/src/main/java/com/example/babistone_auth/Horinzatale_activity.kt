...
class Horinzatale_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        liste_fashion2.add(fashio_model("figurine chat noir",100,R.drawable.chaton))
        liste_fashion2.add(fashio_model("beignet",100,R.drawable.beignet))
        liste_fashion2.add(fashio_model("bible",100,R.drawable.bible_logo))
        ...
        liste_fashion3.add(fashio_model("figurine alya",100,R.drawable.alya))
        liste_fashion3.add(fashio_model("laptop tactil",250,R.drawable.laptop_tactil))
