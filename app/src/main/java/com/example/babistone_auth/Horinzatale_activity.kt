...
class Horinzatale_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        liste_fashion.add(fashio_model("Humberguer",300,R.drawable.marie))
        liste_fashion.add(fashio_model("Pc lenovo",300,R.drawable.marie))
        liste_fashion.add(fashio_model("chemise 2",100,R.drawable.marie))
        liste_fashion.add(fashio_model("banane",100,R.drawable.air_pot))
        liste_fashion2.add(fashio_model("casque",100,R.drawable.marie))
        liste_fashion2.add(fashio_model("figurine chat noir",100,R.drawable.marie))
        liste_fashion2.add(fashio_model("beignet",100,R.drawable.marie))
        liste_fashion2.add(fashio_model("bible",100,R.drawable.marie))
        liste_fashion3.add(fashio_model("marienette",100,R.drawable.marie))
        liste_fashion3.add(fashio_model("Humbergeur",100,R.drawable.marie))
        liste_fashion3.add(fashio_model("figurine alya",100,R.drawable.marie))
        liste_fashion3.add(fashio_model("laptop tactil",250,R.drawable.marie))
